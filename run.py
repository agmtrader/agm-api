...
def start_api():
    ...
    # Entities
    from src.app.entities import accounts, advisors, applications, contacts, documents, fee_template_requests, leads, pending_tasks, users, advisor_changes, management_type_requests

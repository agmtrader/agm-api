...
def start_api():
    ...
    # Tools
    from src.app.tools import email, investment_proposals, message_center, reporting, risk_profiles, trade_tickets
    ...
    # Entities
    from src.app import accounts, advisors, applications, contacts, fee_template_requests, leads, pending_tasks, users
